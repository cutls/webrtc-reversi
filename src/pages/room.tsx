...
import { join } from '@/utils/webrtc'
import { Alert, AlertIcon, Box, Container, Flex, Progress, Text } from '@chakra-ui/react'
	...
	return (
		<>
			...
			<Container p={2}>
				...
				{state === 'playing' && config.haveTime > 0 && (
					<Flex mt={5}>
						<Text>
							あと
							<Text as="span" style={{ fontVariantNumeric: 'tabular-nums' }}>
								{timer && timer > 0 ? Math.floor(timer) : '-'}
							</Text>
							秒
						</Text>
						<Box w={200} ml={2} pt={1}>
